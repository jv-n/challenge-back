...
INSERT INTO "new_ProductsOnCart" ("assignedAt", "cartId", "price_total", "price_unic", "prod_amount", "productId") SELECT "assignedAt", "cartId", coalesce("price_total", 0) AS "price_total", coalesce("price_unic", 0) AS "price_unic", "prod_amount", "productId" FROM "ProductsOnCart";
